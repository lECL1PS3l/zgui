...
/// Direct Telegram WebSocket connection with an explicit endpoint path.
/// Test datacentres use `/apiws_test`; regular traffic uses `/apiws`.
#[allow(clippy::too_many_arguments)]
pub async fn connect_ws_for_dc_path_with_outbound(
    ip: &str,
    dc: u32,
    is_media: bool,
    path: &str,
